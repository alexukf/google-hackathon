...
public class NetworkImageView extends ImageView {
	...
	public void setImageUrl(String url, ImageLoader imageLoader, int maxWidth,
		...
		mImageLoader = imageLoader;
		// The URL has potentially changed. See if we need to load it.
		loadImageIfNecessary(false, maxWidth, maxHeight);
	}
	...
	private void loadImageIfNecessary(final boolean isInLayoutPass) {
		...
		final long currentLoadingStartTime = System.currentTimeMillis();
		...
		ImageContainer newContainer = mImageLoader.get(mUrl,
				new ImageListener() {
					...
					public void onResponse(final ImageContainer response,
						...
						Log.v("VolleyLoadingTime",
								(String.valueOf((System.currentTimeMillis()
										- currentLoadingStartTime) / 1000)));
