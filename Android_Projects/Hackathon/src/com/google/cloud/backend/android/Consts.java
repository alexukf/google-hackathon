...
public interface Consts {
   ...
   */
  public static final String PROJECT_ID = "stone-notch-404";

  /**
   * Set Project Number of your Google APIs Console Project.
   */
  public static final String PROJECT_NUMBER = "357201289067";

  /**
   * Set your Web Client ID for authentication at backend.
   */
  public static final String WEB_CLIENT_ID = "357201289067-qc1is393arr830dpf2ndm6uj7kmndhps.apps.googleusercontent.com";
