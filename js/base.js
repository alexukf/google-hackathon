...
google.devrel.samples.hello.CLIENT_ID =
   '357201289067-qc1is393arr830dpf2ndm6uj7kmndhps.apps.googleusercontent.com';
...
google.devrel.samples.hello.queryDataStore = function(id) {
   gapi.client.datastore.datasets.runQuery({
		datasetId: 'pong4game',
		gqlQuery: {
			queryString: 'SELECT * FROM Greeting'
		  }
 }).execute(function(resp) {
...
google.devrel.samples.hello.enableButtons = function() {
 ...
 document.getElementById('authedGreeting').onclick = function() {
   google.devrel.samples.hello.queryDataStore();//authedGreeting();
 }
...
google.devrel.samples.hello.init = function(apiRoot) {
 ...
 gapi.client.load('datastore', 'v1beta1', callback);
